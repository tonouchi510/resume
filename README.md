...
- 「人物ごとのアルバム」機能では、写真や動画を顔分類するために、顔検出、顔向き推定、年齢・性別推定、顔特徴抽出、クラスタリング、クラスタと人物の属性寄せなど、さまざまなモデル・アルゴリズムが動作している
  - それぞれの手法の改良を続けてきた、特に難易度が高いのは以下
- 特徴抽出モデル更新における後方互換性という実務課題に取り組んだ話
  - 背景：アプリの海外展開に伴い、日本人のみで学習されたモデルを外国人顔にも対応させる必要があった
...
- フィットネス事業での姿勢推定（OpenPose）
  - ヨガなどの姿勢・静止評価にOpenPoseによる解析を活用
- SimCLRの分散学習の実装
