...
コンピュータービジョン（CV）系の研究開発、設計・ソフトウェアアーキテクト、バックエンド開発（Golang, Python）などのタスクに取り組んでいます。
ただし、必要に応じてあらゆる技術を触るのが好きです。

以下、経験詳細で記載の通り、長く運用している大規模サービスから、PoC的な技術検証含め、様々なステージの開発経験を経験してきています。最近はより研究開発色の強いタスクにも取り組んでいます。
